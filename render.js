            ...
            search.addEventListener('input', function() {
                ...
                searchTimeout = setTimeout(() => {
                    if (query.length >= 2) {
                        ...
                        // FIX: was NeuroSarathi.Search.clear(), which wipes the
                        // input's own value — wrong for the "still typing, under
                        // 2 chars" case. Only reset the feed content, leave the
                        // input alone. clear() is reserved for the explicit
                        // searchClear button below.
                        NeuroSarathi.Feed?.load?.(true);
                    }
                }, 300);
            });
